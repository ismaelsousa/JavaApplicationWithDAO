 ...
 * @author ismae
 */
public class FormCondominio extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Condominio c");
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idLocador}"));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idLocador}"), idLocadorField, org.jdesktop.beansbinding.BeanProperty.create("text"));
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FormCondominio.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FormCondominio.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FormCondominio.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FormCondominio.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<beans.Condominio> toRemove = new ArrayList<beans.Condominio>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            beans.Condominio c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        beans.Condominio c = new beans.Condominio();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<beans.Condominio> merged = new ArrayList<beans.Condominio>(list.size());
            for (beans.Condominio c : list) {
    ...
    private java.util.List<beans.Condominio> list;
