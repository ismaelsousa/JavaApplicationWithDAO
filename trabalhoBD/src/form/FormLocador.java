 ...
 * @author ismae
 */
public class FormLocador extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT l FROM Locador l");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FormLocador.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FormLocador.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FormLocador.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FormLocador.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<beans.Locador> toRemove = new ArrayList<beans.Locador>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            beans.Locador l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        beans.Locador l = new beans.Locador();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<beans.Locador> merged = new ArrayList<beans.Locador>(list.size());
            for (beans.Locador l : list) {
    ...
    private java.util.List<beans.Locador> list;
