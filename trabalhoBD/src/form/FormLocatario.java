 ...
 * @author ismae
 */
public class FormLocatario extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT l FROM Locatario l");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FormLocatario.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FormLocatario.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FormLocatario.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FormLocatario.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<beans.Locatario> toRemove = new ArrayList<beans.Locatario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            beans.Locatario l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        beans.Locatario l = new beans.Locatario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<beans.Locatario> merged = new ArrayList<beans.Locatario>(list.size());
            for (beans.Locatario l : list) {
    ...
    private java.util.List<beans.Locatario> list;
